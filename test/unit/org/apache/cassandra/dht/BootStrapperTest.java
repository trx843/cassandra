...
public class BootStrapperTest
{
    ...
    {
        fail("todo: rewrite to use ClusterMetadata");
        //
...
//        };
//        RangeStreamer s = null; // TODO (alexp)
//        //new RangeStreamer(tmd, null, myEndpoint, StreamOperation.BOOTSTRAP, true, DatabaseDescriptor.getEndpointSnitch(), new StreamStateStore(), mockFailureDetector, false, 1);
...
//        generateFakeEndpoints(StorageService.instance.getTokenMetadata(), numOldNodes, 1);
    ...
    private void generateFakeEndpoints(ClusterMetadata metadata, int numOldNodes, int numVNodes) throws UnknownHostException
    {
//        tmd.clearUnsafe();
        generateFakeEndpoints(metadata, numOldNodes, numVNodes, "0", "0");
    }

    Random rand = new Random(1);

    private void generateFakeEndpoints(ClusterMetadata metadata, int numOldNodes, int numVNodes, String dc, String rack) throws UnknownHostException
    {
